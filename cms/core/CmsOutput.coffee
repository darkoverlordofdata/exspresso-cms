...
module.exports = class cms.core.CmsOutput extends system.core.Output
  ...
  constructor: ($args...) ->
    ...
    log_message 'debug', 'CmsOutput Initialized'
    #
  ...
  _write_cache: ($output) ->
    ...
    log_message 'debug', 'CACHE [%s] %s', $ttl, $uri
